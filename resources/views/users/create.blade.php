...
@error('password') is-invalid @enderror" id="exampleInputPassword" placeholder="Password" name="password">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('level') is-invalid @enderror" id="exampleInputlevel"
                            name="level">
                            <option value="penyedia" @if(old('level')=='penyedia' )selected @endif> Penyedia</option>
                            <option value="penjual" @if(old('level')=='penjual' )selected @endif>Penjual</option>
                            <option value="pengrajin" @if(old('level')=='pengrajin' )selected @endif>Pengrajin</option>
                        </select>
