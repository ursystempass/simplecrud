...
@error('total_keluar') is-invalid @enderror" id="total_keluar" placeholder="total_keluar" name="total_keluar">
                        @error('total_keluar') <span class="text-danger">{{$message}}</span> @enderror
</div>
<div class="form-group">
                        <!-- <label for="nama_barang">Nama Barang</label>
                        <input type="nama_barang" class="form-control 
@error('nama_barang') is-invalid @enderror" id="nama_barang" placeholder="nama_barang" name="nama_barang">
